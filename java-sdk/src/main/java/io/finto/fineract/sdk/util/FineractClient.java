...
import io.finto.fineract.sdk.api.AccountNumberFormatApi;
import io.finto.fineract.sdk.api.AccountTransfersApi;
import io.finto.fineract.sdk.api.AccountingClosureApi;
import io.finto.fineract.sdk.api.AccountingRulesApi;
import io.finto.fineract.sdk.api.AdhocQueryApiApi;
import io.finto.fineract.sdk.api.AuditsApi;
import io.finto.fineract.sdk.api.AuthenticationHttpBasicApi;
import io.finto.fineract.sdk.api.BatchApiApi;
import io.finto.fineract.sdk.api.BusinessDateManagementApi;
import io.finto.fineract.sdk.api.BusinessStepConfigurationApi;
import io.finto.fineract.sdk.api.CacheApi;
import io.finto.fineract.sdk.api.CashierJournalsApi;
import io.finto.fineract.sdk.api.CashiersApi;
import io.finto.fineract.sdk.api.CentersApi;
import io.finto.fineract.sdk.api.ChargesApi;
import io.finto.fineract.sdk.api.ClientApi;
import io.finto.fineract.sdk.api.ClientChargesApi;
import io.finto.fineract.sdk.api.ClientIdentifierApi;
import io.finto.fineract.sdk.api.ClientTransactionApi;
import io.finto.fineract.sdk.api.ClientsAddressApi;
import io.finto.fineract.sdk.api.CodeValuesApi;
import io.finto.fineract.sdk.api.CodesApi;
import io.finto.fineract.sdk.api.CurrencyApi;
import io.finto.fineract.sdk.api.DataTablesApi;
import io.finto.fineract.sdk.api.DefaultApi;
import io.finto.fineract.sdk.api.DelinquencyRangeAndBucketsManagementApi;
import io.finto.fineract.sdk.api.EntityDataTableApi;
import io.finto.fineract.sdk.api.EntityFieldConfigurationApi;
import io.finto.fineract.sdk.api.ExternalServicesApi;
import io.finto.fineract.sdk.api.FetchAuthenticatedUserDetailsApi;
import io.finto.fineract.sdk.api.FixedDepositAccountApi;
import io.finto.fineract.sdk.api.FixedDepositProductApi;
import io.finto.fineract.sdk.api.FloatingRatesApi;
import io.finto.fineract.sdk.api.GeneralLedgerAccountApi;
import io.finto.fineract.sdk.api.GlobalConfigurationApi;
import io.finto.fineract.sdk.api.GroupsApi;
import io.finto.fineract.sdk.api.HolidaysApi;
import io.finto.fineract.sdk.api.HooksApi;
import io.finto.fineract.sdk.api.InterestRateChartApi;
import io.finto.fineract.sdk.api.InterestRateSlabAKAInterestBandsApi;
import io.finto.fineract.sdk.api.JournalEntriesApi;
import io.finto.fineract.sdk.api.ListReportMailingJobHistoryApi;
import io.finto.fineract.sdk.api.LoanChargesApi;
import io.finto.fineract.sdk.api.LoanCobCatchUpApi;
import io.finto.fineract.sdk.api.LoanCollateralApi;
import io.finto.fineract.sdk.api.LoanDisbursementDetailsApi;
import io.finto.fineract.sdk.api.LoanProductsApi;
import io.finto.fineract.sdk.api.LoanReschedulingApi;
import io.finto.fineract.sdk.api.LoanTransactionsApi;
import io.finto.fineract.sdk.api.LoansApi;
import io.finto.fineract.sdk.api.MakerCheckerOr4EyeFunctionalityApi;
import io.finto.fineract.sdk.api.MappingFinancialActivitiesToAccountsApi;
import io.finto.fineract.sdk.api.MixMappingApi;
import io.finto.fineract.sdk.api.MixReportApi;
import io.finto.fineract.sdk.api.MixTaxonomyApi;
import io.finto.fineract.sdk.api.NotesApi;
import io.finto.fineract.sdk.api.NotificationApi;
import io.finto.fineract.sdk.api.OfficesApi;
import io.finto.fineract.sdk.api.PasswordPreferencesApi;
import io.finto.fineract.sdk.api.PaymentTypeApi;
import io.finto.fineract.sdk.api.PeriodicAccrualAccountingApi;
import io.finto.fineract.sdk.api.PermissionsApi;
import io.finto.fineract.sdk.api.PocketApi;
import io.finto.fineract.sdk.api.ProvisioningCategoryApi;
import io.finto.fineract.sdk.api.ProvisioningCriteriaApi;
import io.finto.fineract.sdk.api.ProvisioningEntriesApi;
import io.finto.fineract.sdk.api.RecurringDepositAccountApi;
import io.finto.fineract.sdk.api.RecurringDepositAccountTransactionsApi;
import io.finto.fineract.sdk.api.RecurringDepositProductApi;
import io.finto.fineract.sdk.api.ReportMailingJobsApi;
import io.finto.fineract.sdk.api.ReportsApi;
import io.finto.fineract.sdk.api.RescheduleLoansApi;
import io.finto.fineract.sdk.api.RolesApi;
import io.finto.fineract.sdk.api.SavingsAccountApi;
import io.finto.fineract.sdk.api.SavingsAccountTransactionsApi;
import io.finto.fineract.sdk.api.SavingsChargesApi;
import io.finto.fineract.sdk.api.SavingsProductApi;
import io.finto.fineract.sdk.api.SchedulerApi;
import io.finto.fineract.sdk.api.SchedulerJobApi;
import io.finto.fineract.sdk.api.ScoreCardApi;
import io.finto.fineract.sdk.api.SearchApiApi;
import io.finto.fineract.sdk.api.SelfAccountTransferApi;
import io.finto.fineract.sdk.api.SelfAuthenticationApi;
import io.finto.fineract.sdk.api.SelfClientApi;
import io.finto.fineract.sdk.api.SelfDividendApi;
import io.finto.fineract.sdk.api.SelfLoanProductsApi;
import io.finto.fineract.sdk.api.SelfLoansApi;
import io.finto.fineract.sdk.api.SelfRunReportApi;
import io.finto.fineract.sdk.api.SelfSavingsAccountApi;
import io.finto.fineract.sdk.api.SelfScoreCardApi;
import io.finto.fineract.sdk.api.SelfServiceRegistrationApi;
import io.finto.fineract.sdk.api.SelfShareAccountsApi;
import io.finto.fineract.sdk.api.SelfSpmApi;
import io.finto.fineract.sdk.api.SelfThirdPartyTransferApi;
import io.finto.fineract.sdk.api.SelfUserApi;
import io.finto.fineract.sdk.api.SelfUserDetailsApi;
import io.finto.fineract.sdk.api.ShareAccountApi;
import io.finto.fineract.sdk.api.SpmApiLookUpTableApi;
import io.finto.fineract.sdk.api.SpmSurveysApi;
import io.finto.fineract.sdk.api.StaffApi;
import io.finto.fineract.sdk.api.StandingInstructionsApi;
import io.finto.fineract.sdk.api.StandingInstructionsHistoryApi;
import io.finto.fineract.sdk.api.TaxComponentsApi;
import io.finto.fineract.sdk.api.TaxGroupApi;
import io.finto.fineract.sdk.api.TellerCashManagementApi;
import io.finto.fineract.sdk.api.UserGeneratedDocumentsApi;
import io.finto.fineract.sdk.api.UsersApi;
import io.finto.fineract.sdk.api.WorkingDaysApi;
...
public class FineractClient {
    ...
    public static final class Builder {
        ...
        public Builder logging(Logbook logbook) {
            okBuilder.addInterceptor(new LogbookInterceptor(logbook));
            return this;
        }
