...
public interface FineractLoanProductMapper {
    ...
    @Mapping(target = "isInterestRecalculationEnabled", source = "request.isInterestRecalculationEnabled", qualifiedByName = "fromOptional")
    @Mapping(target = "overdueDaysForNPA", source = "request.overdueDaysForNPA", qualifiedByName = "fromOptional")
    @Mapping(target = "preClosureInterestCalculationStrategy", source = "request.preClosureInterestCalculationStrategy", qualifiedByName = "fromOptional")
    @Mapping(target = "rescheduleStrategyMethod", source = "request.rescheduleStrategyMethod", qualifiedByName = "fromOptional")
    @Mapping(target = "interestRecalculationCompoundingMethod", source = "request.interestRecalculationCompoundingMethod", qualifiedByName = "fromOptional")
    @Mapping(target = "recalculationRestFrequencyType", source = "request.recalculationRestFrequencyType", qualifiedByName = "fromOptional")
    @Mapping(target = "recalculationRestFrequencyInterval", source = "request.recalculationRestFrequencyInterval", qualifiedByName = "fromOptional")
    @Mapping(target = "principalThresholdForLastInstallment", source = "request.principalThresholdForLastInstallment", qualifiedByName = "fromOptional")
    @Mapping(target = "minimumDaysBetweenDisbursalAndFirstRepayment", source = "request.minimumFirstPaymentInterval", qualifiedByName = "fromOptional")
    ...
    @Mapping(target = "firstPaymentDay", source = "request.firstPaymentDay", qualifiedByName = "fromOptional")
    ...
    @Mapping(target = "firstPaymentDay", source = "additionalDetails.firstPaymentDay")
    @Mapping(target = "minimumFirstPaymentInterval", source = "loanProduct.minimumDaysBetweenDisbursalAndFirstRepayment")
    ...
    default List<PostLoansRequestDatatablesInner> toLoanDataTables(LoanCreate request) {
        ...
        return List.of(PostLoansRequestDatatablesInner.builder()
                ...
                .data(PostLoansRequestDatatablesInnerData.builder()
                        ...
                        .externalSettlementAccount(request.getExternalSettlementAccount())
                        .externalBnplAccount(request.getExternalBnplAccount())
    ...
    @Mapping(target = "externalSettlementAccount", expression = "java(fromDataTablesToString(additionalDetails, \"external_settlement_account\"))")
    @Mapping(target = "externalBnplAccount", expression = "java(fromDataTablesToString(additionalDetails, \"external_bnpl_account\"))")
